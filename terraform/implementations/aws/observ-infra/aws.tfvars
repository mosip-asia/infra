...
rancher_hostname           = "rancher.demo.mosip.sandbox.cs.ait.ac.th" # example rancher.sandbox.xyz.net
...
keycloak_hostname = "iam.demo.mosip.sandbox.cs.ait.ac.th" # example iam.sandbox.xyz.net
